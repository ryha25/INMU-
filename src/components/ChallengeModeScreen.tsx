...
function scenarioForLevel(level: number) {
  ...
  const L: Partial<Record<number, Cfg>> = {
    ...
    61: { s:'mirrorBattle',  t:10, th:1, h:0, r:'富豪',   d:'CPU難易度：強い。対等な手札での純粋な実力勝負。' },
    62: { s:'doubleThreat',  t:9,  th:2, h:0, r:'富豪',   d:'CPU2人・難易度：強い。2方向を読みながら上がれ。' },
    63: { s:'cpuStrong',     t:10, th:1, h:0, r:'富豪',   d:'CPU難易度：強い。8切りを温存する相手を崩して制圧しろ。' },
    64: { s:'cpuRevolution', t:9,  th:1, h:0, r:'富豪',   d:'CPU難易度：強い。革命前後の強弱を正確に読んで戦え。' },
    65: { s:'doubleThreat',  t:9,  th:2, h:0, r:'大富豪', d:'CPU2人・難易度：強い。残り1枚まで気を抜かない相手。' },
    66: { s:'cpuStrong',     t:9,  th:1, h:0, r:'富豪',   d:'CPU難易度：強い。ジョーカーを温存する相手を崩して勝て。' },
    67: { s:'doubleSiege',   t:10, th:2, h:0, r:'大富豪', d:'CPU2人・難易度：強い。役を崩すタイミングを読み切れ。' },
    68: { s:'lastStand',     t:9,  th:1, h:1, r:'大富豪', d:'CPU難易度：強い＋強カード1枚没収。逆境で戦え。' },
    69: { s:'cpuRevolution', t:9,  th:2, h:1, r:'大富豪', d:'💥CPU2人・革命中・強カード没収。重なった逆境を突破しろ。' },
    70: { s:'finalBoss',     t:10, th:3, h:0, r:'大富豪', d:'CPU3人・難易度：強い。全員を相手にした総力戦。' },
    // ── Lv 71〜80: 特殊クリア条件・上級 ────────────────────────────────
    71: { s:'effectRequired',t:7,  th:1, h:0, r:'大富豪', req:'8切り',          d:'8切りで場を流して上がれ。タイミングが勝負の鍵。' },
    72: { s:'effectRequired',t:7,  th:1, h:0, r:'大富豪', req:'ジョーカー',     d:'ジョーカーを最後まで温存して勝て。切るタイミングを誤るな。' },
    73: { s:'effectRequired',t:7,  th:1, h:0, r:'大富豪', req:'革命',           d:'革命で弱いカードを処理して上がれ。4枚組の保持が最優先。' },
    74: { s:'lastStand',     t:7,  th:1, h:0, r:'大富豪', d:'ペアを崩して単体で使う判断が鍵。手順を読んで確実に上がれ。' },
    75: { s:'mirrorBattle',  t:7,  th:1, h:0, r:'大富豪', d:'あえて1回パスすると勝てる構成。冷静に場を読め。' },
    76: { s:'effectRequired',t:7,  th:1, h:0, r:'大富豪', req:'階段',           d:'階段を使う順番が重要。同スート連番を温存しろ。' },
    77: { s:'doubleThreat',  t:7,  th:2, h:0, r:'大富豪', d:'CPU2人。片方だけを警戒すると負ける。両方の上がりを同時に封じろ。' },
    78: { s:'cpuRevolution', t:7,  th:1, h:0, r:'大富豪', d:'💥革命中。強弱逆転の状況で冷静に手を組み直して上がれ。' },
    79: { s:'curseCombo',    t:7,  th:1, h:0, r:'大富豪', suit:'clubs',         d:'クラブ縛り状態。縛りを継続するか切るか局面ごとに判断しろ。' },
    80: { s:'effectRequired',t:7,  th:2, h:0, r:'大富豪', req:'革命',           d:'CPU2人。革命を正しいタイミングで使って大富豪を取れ。' },
    // ── Lv 81〜90: 複合ルール上級 ─────────────────────────────────────
    ...
    84: { s:'curseCombo',    t:9,  th:2, h:1, r:'大富豪', ban:'7渡し', suit:'diamonds', pass:1, turn:20, d:'CPU2人・ダイヤ縛り・強カード没収・⛔パス1回・⏱20ターン以内。重圧に耐えろ。' },
    85: { s:'effectForbidden',t:9, th:1, h:0, r:'大富豪', ban:'8切り',          d:'8切り禁止。8を切り札にせず手の強さだけで突破しろ。' },
    86: { s:'doubleThreat',  t:7,  th:1, h:0, r:'大富豪', turn:20,              d:'CPU1人。⏱20ターン以内に制圧しろ。' },
    87: { s:'doubleThreat',  t:9,  th:2, h:1, r:'大富豪', np:true,              d:'CPU2人・✋ペア禁止・強カード没収。1枚ずつの戦いで突破しろ。' },
    88: { s:'finalBoss',     t:10, th:3, h:0, r:'大富豪', d:'CPU3人・💥革命中・難易度：強い。全包囲を突破せよ。' },
    89: { s:'doubleThreat',  t:9,  th:2, h:1, r:'大富豪', ns:true,              d:'CPU2人・✋階段禁止・強カード没収。縛りの中で上がり筋を作れ。' },
    ...
    95: { s:'doubleSiege',   t:10, th:2, h:1, r:'大富豪', ban:'革命',           d:'CPU2人・革命禁止。通常の強弱を崩さず純粋な力勝負を制せ。' },
    ...
    98: { s:'bruteForce',    t:8,  th:3, h:1, r:'大富豪', d:'CPU3人・強カード没収。全力の包囲を崩して上がれ。' },
    99: { s:'finalBoss',     t:10, th:3, h:1, r:'大富豪', pass:2, turn:30,      d:'CPU3人・最高難易度・⛔パス2回・⏱30ターン以内。全力の壁を突き崩せ。' },
    // ── Lv 100: 最終試練 ──────────────────────────────────────────────
    100:{ s:'finalBoss',     t:10, th:3, h:0, r:'大富豪', d:'【最終試練】CPU3人・最高難易度・固定手札。革命・8切り・ペア・階段をすべて活用し、正しいカード管理で大富豪の称号を掴め。' },
  }
