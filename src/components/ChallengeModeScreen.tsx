...
function scenarioForLevel(level: number) {
  ...
  const L: Partial<Record<number, Cfg>> = {
    ...
    9:  { s:'sniperRush',    t:5,  th:1, h:0, r:'富豪',   req:'ジョーカー',     d:'ジョーカーを使って1位になれ。♠3返しを意識しながら制圧しろ。' },
    ...
    45: { s:'lastStand',     t:5,  th:1, h:0, r:'富豪',   turn:15,  d:'⏱15ターン以内に1位になれ。長引くと失敗。' },
    ...
    90: { s:'finalBoss',     t:5,  th:3, h:1, r:'大富豪', ban:'ジョーカー', turn:25, d:'CPU3人・💥革命中・ジョーカー禁止・強カード没収・⏱25ターン以内。最高難度の壁。' },
    // ── Lv 91〜99: 最高難易度 ─────────────────────────────────────────
