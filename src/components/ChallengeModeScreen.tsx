...
export function scenarioForLevel(level: number) {
  const L: Partial<Record<number, ChallengeLevelConfig>> = {
    ...
    79: { s:'cpuStrong',     t:7,  th:1, h:0, r:'大富豪', suit:'spades', pass:3,               d:'スペード縛り・⛔パス3回まで。Jの切り方を見極め、CPUの2革命返しを避けて上がれ。' },
    ...
    99: { s:'doubleSiege', t:11, th:2, h:1, r:'大富豪', req:'8切り', ban:'革命', fv:11, fc:1, pass:2, turn:24, ns:true, d:'CPU2人全力強化・強カード没収・J盤面スタート・革命禁止・階段禁止・⛔パス2回・⏱24ターン。8切りと11バックを組み合わせて活路を開け。' },
    // ── Lv 100: 最終試練 ──────────────────────────────────────────────
