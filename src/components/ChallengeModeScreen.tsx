...
function scenarioForLevel(level: number) {
  ...
  const L: Partial<Record<number, Cfg>> = {
    ...
    99: { s:'doubleSiege', t:11, th:2, h:1, r:'大富豪', req:'8切り', ban:'革命', fv:11, fc:1, pass:2, turn:24, d:'CPU2人全力強化・強カード没収・J盤面スタート・革命禁止・⛔パス2回・⏱24ターン。8切りの使い時を見極めろ。' },
    // ── Lv 100: 最終試練 ──────────────────────────────────────────────
    100:{ s:'doubleSiege', t:14, th:3, h:0, r:'大富豪', req:'革命', ban:'ジョーカー', fv:12, fc:2, pass:1, turn:35, d:'【最終試練】CPU3人強化・Qペア盤面スタート・ジョーカー禁止・⛔パス1回・⏱35ターン。4枚組で革命を起こし、すべてを逆転させよ。' },
  }
