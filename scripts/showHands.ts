...
function scenarioForLevel(level: number) {
  ...
  const L: Partial<Record<number, Cfg>> = {
    ...
    23: { s:'curseCombo',    t:6,  th:1, h:0, r:'富豪',   ban:'7渡し', suit:'hearts', d:'' },
    ...
    29: { s:'lockedHand',    t:6,  th:1, h:0, r:'富豪',   suit:'spades',        d:'' },
    ...
    49: { s:'sniperRush',    t:5,  th:1, h:0, r:'大富豪', cj:true,              d:'' },
    ...
    55: { s:'curseCombo',    t:5,  th:1, h:0, r:'富豪',   ban:'7渡し', suit:'hearts', turn:15, d:'' },
    ...
    79: { s:'curseCombo',    t:4,  th:1, h:0, r:'大富豪', suit:'clubs',         d:'' },
    ...
    84: { s:'curseCombo',    t:5,  th:2, h:1, r:'大富豪', ban:'7渡し', suit:'diamonds', pass:1, turn:12, d:'' },
    ...
    96: { s:'finalBoss',     t:5,  th:3, h:1, r:'大富豪', ban:'ジョーカー', suit:'spades', d:'' },
