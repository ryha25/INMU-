...
function scenarioForLevel(level: number) {
  ...
  const L: Partial<Record<number, Cfg>> = {
    ...
    61: { s:'mirrorBattle',  t:10, th:1, h:0, r:'富豪',   d:'' },
    62: { s:'doubleThreat',  t:9,  th:2, h:0, r:'富豪',   d:'' },
    63: { s:'cpuStrong',     t:10, th:1, h:0, r:'富豪',   d:'' },
    64: { s:'cpuRevolution', t:9,  th:1, h:0, r:'富豪',   d:'' },
    65: { s:'doubleThreat',  t:9,  th:2, h:0, r:'大富豪', d:'' },
    66: { s:'cpuStrong',     t:9,  th:1, h:0, r:'富豪',   d:'' },
    67: { s:'doubleSiege',   t:10, th:2, h:0, r:'大富豪', d:'' },
    68: { s:'lastStand',     t:9,  th:1, h:1, r:'大富豪', d:'' },
    69: { s:'cpuRevolution', t:9,  th:2, h:1, r:'大富豪', d:'' },
    70: { s:'finalBoss',     t:10, th:3, h:0, r:'大富豪', d:'' },
    71: { s:'effectRequired',t:7,  th:1, h:0, r:'大富豪', req:'8切り',          d:'' },
    72: { s:'effectRequired',t:7,  th:1, h:0, r:'大富豪', req:'ジョーカー',     d:'' },
    73: { s:'effectRequired',t:7,  th:1, h:0, r:'大富豪', req:'革命',           d:'' },
    74: { s:'lastStand',     t:7,  th:1, h:0, r:'大富豪', d:'' },
    75: { s:'mirrorBattle',  t:7,  th:1, h:0, r:'大富豪', d:'' },
    76: { s:'effectRequired',t:7,  th:1, h:0, r:'大富豪', req:'階段',           d:'' },
    77: { s:'doubleThreat',  t:7,  th:2, h:0, r:'大富豪', d:'' },
    78: { s:'cpuRevolution', t:7,  th:1, h:0, r:'大富豪', d:'' },
    79: { s:'curseCombo',    t:7,  th:1, h:0, r:'大富豪', suit:'clubs',         d:'' },
    80: { s:'effectRequired',t:7,  th:2, h:0, r:'大富豪', req:'革命',           d:'' },
